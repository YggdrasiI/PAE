...
void CyEnumsPythonInterface()
{
	...
	python::enum_<CultureRestrictionTypes>("CultureRestrictionTypes")
		.value("NO_CULTURE_RESTRICTION", NO_CULTURE_RESTRICTION)
		.value("CULTURE_RESTRICTION_HOMELAND", CULTURE_RESTRICTION_HOMELAND)
		.value("CULTURE_RESTRICTION_VASALLS", CULTURE_RESTRICTION_VASALLS)
		.value("CULTURE_RESTRICTION_NO_FOREIGN", CULTURE_RESTRICTION_NO_FOREIGN)
		.value("NUM_CULTURE_RESTRICTION_TYPES", NUM_CULTURE_RESTRICTION_TYPES)
		;
